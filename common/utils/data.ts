...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "This extensions helps install the shadcn/ui components directly from VS Code. This extension is a great way to speed up the development process and make it easier to use shadcn/ui components in your react projects. This project has over 18K downloads on the VS Code marketplace.",
    usedTechs: [
      techMap.openSource,
      techMap.typescript,
      techMap.shadcnUI,
